...
public class MessageItem {
	 ...
	 * @param dateTime
	 *            time message was sent in java Class LocalDateTime format
	 * @param message
	 *            the message
	 */
	 ...
	 * 
	 * @param dateTime
	 *            time sent in LocalDateTime format
	 */
	...
	public String toString() {
		return "[" + this.dateTime.getHour() + ":" + this.dateTime.getMinute() + "] " + this.userName + " : "
				+ this.message;
	}
}
