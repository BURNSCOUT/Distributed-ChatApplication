...
public class DateTimeFileNameFormatter {
	...
	/**
	 * Formats DateTime String from 'yyyy-MM-dd HH:mm:ss.f' to
	 * 'yyyy-MM-dd_HH-mm-ss.f'
	 * 
	 * @param dateTime
	 *            timestamp the sql timestamp in 'yyyy-mm-dd hh:mm:ss' format
	 ...
	 * 
	 * @param dateTime
	 *            LocalDateTime the date and time in 'yyyy-mm-dd hh:mm:ss' format
	 * @return A string that can be set as a file name
	 */
	 ...
	 * 
	 * @param dateTime
	 *            a String in 'yyyy-dd-mmTHH:mm:ss' format
	 * @return A string that can be set as a file name
	 */
